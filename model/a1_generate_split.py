...
from a0_config import aws_split_config as split_config
...
def generate_folders(output_directory, mode,split_config=split_config):
    '''Generates 6 folders (image, bounding boxes, layouts, marks, charts, orientations) given a mode "train" or "test"'''
    # folder_names = ["images", "bbox", "layouts","marks"]
...
def create_split(split_config):
    # folder_paths = [image_folder, bbox_folder, layout_folder,mark_folder]
...
if __name__ == "__main__":
    ...
    print(f"The data has been created at /data/splits/split-{SEED}-{TEST_SIZE}")