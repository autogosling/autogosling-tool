'''
This is an utility script to debug images generated by a3.
Displays an image generated by the Yolov7 Dataset generation algorithm (a3_generate_yolov7.py)
It uses PIL to show the image and saves it to previews/preview-{stem}.png where stem is the name of the image
'''
